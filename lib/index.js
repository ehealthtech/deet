...
module.exports = function(opts) {
    ...
    var useMultipartParser = typeof opts.useMultipartParser !== 'undefined'
                                ? !!opts.useMultipartParser
                                : true;

    var tempUploadFolder = opts.tempUploadFolder || os.tmpDir();

    var fileFilter = typeof opts.fileFilter === 'function'
                        ? opts.fileFilter
                        : false;
            ...
            try {
                ...
                busboy.on('file', function(fieldname, filestream, filename, encoding, mimetype) {
                    ...
                    if(fileFilter && !fileFilter(req.files.file, req.headers)) {
                        ...
                        req.files.rejected.push(util.format('%s~~%s', fieldname, filename));
                        req.files.file = null;
